    ...
    <section className="mx-auto mt-14 w-[min(1200px,95%)]">
      ...
      <div className="grid gap-4 md:grid-cols-3 md:items-center">
        <article className="group glass-card hover-tilt flex h-full flex-col justify-between rounded-3xl p-6 shadow-soft md:mt-6">
          <div>
            <div className="icon-pop grid h-12 w-12 place-items-center rounded-2xl bg-rose-100 text-rose-700"><HeartHandshake className="h-6 w-6" /></div>
        ...
        <article className="group glass-card hover-tilt flex h-full flex-col justify-between rounded-3xl p-6 shadow-soft md:mt-6">
          <div>
            <div className="icon-pop grid h-12 w-12 place-items-center rounded-2xl bg-amber-100 text-amber-700"><CalendarClock className="h-6 w-6" /></div>
